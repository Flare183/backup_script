...
fsarchiver -v restfs /media/xubuntu/EXT-DRIVE/Server_Backup/root2.fsa id=0,dest=/dev/sda1
...
fsarchiver -v restfs /media/xubuntu/EXT-DRIVE/Server_Backup/home2.fsa id=0,dest=/dev/sda3
