...
# Bash Script using partimage to backup the Entire Filesystem
# For Dean's Server
#
...
fsarchiver -v -o savefs /media/xubuntu/EXT-DRIVE/Server_Backup/root2.fsa /dev/sda1
...
fsarchiver -v -o savefs /media/xubuntu/EXT-DRIVE/Server_Backup/home2.fsa /dev/sda3
