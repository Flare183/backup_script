...
sleep 5
apt-get -y install gparted fsarchiver htop
...
echo "Killing XScreenSaver"
killall xscreenssaver
sleep 5
sync
echo "Done"

# Now to run this massive partimage command
echo "Going to run fsarchiver now.."
echo "Only Restoring Root Parition Now"
fsarchiver -v restfs /media/EXT-DRIVE/Pearl/root1.fsa id=0,dest=/dev/sda1
...
fsarchiver -v restfs /media/EXT-DRIVE/Pearl/home1.fsa id=0,dest=/dev/sda3
